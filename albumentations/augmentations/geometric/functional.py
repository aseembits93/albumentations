...
def bboxes_d4(
    ...
    """
    if group_member == "e":
        return bboxes  # Identity transformation
    elif group_member == "r90":
        return bboxes_rot90(bboxes, 1)  # Rotate 90 degrees
    elif group_member == "r180":
        return bboxes_rot90(bboxes, 2)  # Rotate 180 degrees
    elif group_member == "r270":
        return bboxes_rot90(bboxes, 3)  # Rotate 270 degrees
    elif group_member == "v":
        return bboxes_vflip(bboxes)  # Vertical flip
    elif group_member == "hvt":
        return bboxes_transpose(bboxes_rot90(bboxes, 2))  # Reflect over anti-diagonal
    elif group_member == "h":
        return bboxes_hflip(bboxes)  # Horizontal flip
    elif group_member == "t":
        return bboxes_transpose(bboxes)  # Transpose (reflect over main diagonal)
